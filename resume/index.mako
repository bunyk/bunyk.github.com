...
<dl>
    ...
    <dd>
        ...
        <li><strong>Personal blog</strong>: <a href="http://bunyk.wordpress.com/">http://bunyk.wordpress.com/</a></li>
        <li><strong>Google code profile</strong>: <a href="http://code.google.com/u/tbunyk/">http://code.google.com/u/tbunyk/</a> (my code samples)</li>
        <li><strong>GitHub profile</strong>: <a href="https://github.com/bunyk">https://github.com/bunyk</a> (a lot less code samples)</li>
    ...
    <dd><ul>
        <li><p>(2013 &ndash; till now) <a href="http://softserve.ua/">SoftServe</a>, as a JavaScript developer.</p>
        <h3>Technologies:</h3>
        <ul>
            <li>Leaflet</li>
        </ul>
        </li>
        <li><p>(2011 &ndash; 2012) <a href="http://prom.ua/">Prom.ua</a>, as a <strong>junior web-developer</strong> in CRM team.</p>
    ...
    <dd><p>Before was years of small hacks in different programming languages and technologies. For example:</p>
        <ul>
            <li>Scripting Blender to draw some function graphs in 3D. Main work was to learn how to create script GUI, and how to create and manipulate objects inside Blender. (Full story: <a href="http://bunyk.wordpress.com/2010/05/05/blender-scripting-2/">bunyk.wordpress.com/2010/05/05/blender-scripting-2/</a>)</li>
            <li>Freebase queries. Exploring ontology, collecting information about movies. (<a href="http://bunyk.wordpress.com/2011/03/31/hands-on-freebase/">bunyk.wordpress.com/2011/03/31/hands-on-freebase/</a>)</li>
            <li>3D model of rubics cube. One variant was with GUI on Qt. (<a href="http://bunyk.wordpress.com/2009/04/12/cubik/">bunyk.wordpress.com/2009/04/12/cubik/</a>)</li>
            <li>Rendering of n-dimensional cubes. Wireframes in orthogonal projection. (<a href="http://bunyk.wordpress.com/2009/04/27/n-dimensional-cube/">bunyk.wordpress.com/2009/04/27/n-dimensional-cube/</a>)</li>
            <li>Grabbing well-formated content from Mediawiki sites to wordpress. (<a href="http://bunyk.wordpress.com/2011/02/11/wiki-to-wordpress/">bunyk.wordpress.com/2011/02/11/wiki-to-wordpress/</a>)</li>
            <li>SVG planimetrics animation with JavaScript. (<a href="http://bunykprogs.googlecode.com/hg/anim.svg">bunykprogs.googlecode.com/hg/anim.svg</a>)</li>
    ...
    <dd><ul>
        ...
        <li><strong>MediaWiki</strong> &ndash; deep wikimarkup knowledge, and administration skills. I am administrator of Ukrainian wikibooks project. (<a href="http://uk.wikibooks.org/wiki/%D0%9A%D0%BE%D1%80%D0%B8%D1%81%D1%82%D1%83%D0%B2%D0%B0%D1%87:Bunyk">uk.wikibooks.org/wiki/Користувач:Bunyk</a>)</li>
        <li><strong>Mercurial</strong>. Able to fix my own wrong merges. <img class="wp-smiley" alt=":)" src="http://s0.wp.com/wp-includes/images/smilies/icon_smile.gif?m=1129645325g"> </li>
    ...
    <dd><ul>
        ...
        <li><strong>High English to Ukrainian translation skills</strong> &ndash; not so bad even in fiction translation. (<a href="http://bunyk.wordpress.com/2011/04/28/martin-eden/">bunyk.wordpress.com/2011/04/28/martin-eden/</a>)</li>
    </ul></dd>
</dl>
