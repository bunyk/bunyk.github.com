...
html: drawing_html index_html backbone deutsch_html resume hypercube_html canvas_html tree_html gamemap
...
tree_html:
	python3.3 render_mako.py tech_tree/index.mako

gamemap_html:
	python3.3 render_mako.py gamemaps/index.mako
