...
(function() {
  var $, LoadingSprite, LoadingSpriteSet, MovingSprite, Tile, get_random_sprite, wesnoth_image;
  ...
  $(function() {
    ...
    desert_sprite = new LoadingSprite(wesnoth_image('terrain/sand/desert.png'), allready.wait());
    flowers_sprite = new LoadingSprite(wesnoth_image('terrain/grass/green.png'), allready.wait());
    return coast_sprite = new LoadingSprite(wesnoth_image('terrain/water/coast-tile.png'), allready.wait());
  });
